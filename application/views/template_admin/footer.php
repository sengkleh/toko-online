    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url () ?>asset/template/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo base_url () ?>asset/template/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url () ?>asset/template/js/demo/chart-pie-demo.js"></script>
